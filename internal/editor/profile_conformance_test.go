...
var exercisedVimProfileCommands = []string{
	"0",
	"^",
	"$",
	"%",
...
var exercisedHelixProfileCommands = []string{
	"A",
	"B",
	"%",
	"&",
...
func TestAdvertisedProfileCommandsHaveConformanceCoverage(t *testing.T) {
	assertSameStringSet(t, "vim", advertisedVimProfileCommands, exercisedVimProfileCommands)
	assertSameStringSet(t, "helix", advertisedHelixProfileCommands, exercisedHelixProfileCommands)
}
